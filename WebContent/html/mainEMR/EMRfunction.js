...
var PageArray=["mainPage","queryPage","labPage","xrayPage","opPage","inpPage","inpRecordPage","udPage","stPage","focusPage","outNotePage","xrayPosPage","progressPage","admissionPage","chgBedPage","opdRecordPage","germPage","takeHomePage","labChartPage","labSumPage","labSumChartPage","opdMedicineDetailPage","majorDiseasePage","allergyPage","opdDiseaseDARTPage","opdOrderPage"];	//所有視窗
...
/***1070419 add 加入 visitType INP OPD**/

var EMRDateRangeVisitTypeInputObj = function(empNo,sessionID,chartNo,startDate,endDate,visitType,method){
	this.empNo = empNo;
	this.sessionID = sessionID;
	this.chartNo = chartNo;
	this.startDate = startDate;
 ...
 * for call YearsRange
 * */
var EMRYearsVisitTypeInputObj = function(empNo,sessionID,chartNo,years,visitType,method){
	this.empNo = empNo;
	this.sessionID = sessionID;
	this.chartNo = chartNo;
	this.years = years;
 ...
 * for call All
 * */
var EMRAllVisitTypeInputObj = function(empNo,sessionID,chartNo,visitType,method){
	this.empNo = empNo;
	this.sessionID = sessionID;
	this.chartNo = chartNo;
	this.visitType = visitType;
...
var EMRSernoInputObj = function(empNo,sessionID,chartNo,serno,method){
	this.empNo = empNo;
	this.sessionID = sessionID;
	this.chartNo = chartNo;
	this.serno = serno;
...
var PacsSettingInputObj = function(empNo,sessionID,method){
	this.empNo = empNo;
	this.sessionID = sessionID;	
	this.method = method;
};
...
function renderIncludeHtmlURL(){
	...
	$("#queryPage").attr("w3-include-html","../QueryPatient/QueryPatient.html"+url);
	$("#labPage").attr("w3-include-html","../Lab/Lab.html"+url);
	$("#labChartPage").attr("w3-include-html","../Lab/LabChart.html"+url);
	$("#labSumPage").attr("w3-include-html","../Lab/LabSum.html"+url);
	$("#labSumChartPage").attr("w3-include-html","../Lab/LabSumChart.html"+url);
	$("#xrayPage").attr("w3-include-html","../Xray/Xray.html"+url);	
	$("#opPage").attr("w3-include-html","../Operation/Operation.html"+url);	
	$("#inpPage").attr("w3-include-html","../Inp/Inp.html"+url);	
	$("#inpRecordPage").attr("w3-include-html","../InpRecord/InpRecord.html"+url);
	$("#opdOrderPage").attr("w3-include-html","../OpdOrder/OpdOrder.html"+url);//1070510新增 門急轉住醫囑
	
	$("#udPage").attr("w3-include-html","../UD/UD.html"+url);	
	$("#stPage").attr("w3-include-html","../STAT/STAT.html"+url);	
	$("#focusPage").attr("w3-include-html","../Focus/Focus.html"+url);	
	$("#progressPage").attr("w3-include-html","../Progress/Progress.html"+url);	
	$("#chgBedPage").attr("w3-include-html","../ChangeBed/ChangeBed.html"+url);	
	$("#takeHomePage").attr("w3-include-html","../TakeHome/TakeHome.html"+url);	
	$("#opdRecordPage").attr("w3-include-html","../OpdRecord/OpdRecord.html"+url);	
	$("#opdDiseaseDARTPage").attr("w3-include-html","../OpdRecord/OpdDiseaseDART.html"+url);		
	$("#opdMedicineDetailPage").attr("w3-include-html","../OpdRecord/OpdMedicineDetail.html"+url);	
	$("#majorDiseasePage").attr("w3-include-html","../MajorDisease/MajorDisease.html"+url);	
	$("#allergyPage").attr("w3-include-html","../Allergy/Allergy.html"+url);
